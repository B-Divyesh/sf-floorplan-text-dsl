# Text-to-floor-plan: a Markdown-like DSL that renders scaled SVG/PDF blueprints (`floorplan-text-dsl`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://floorplan-text-dsl.sociobot.in`. Artifact class: `static-web`.
